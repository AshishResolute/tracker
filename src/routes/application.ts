...
import { addApplication,getApplications,updateApplication,deleteApplication } from '../controllers/application.controller.js';
...
router.delete('/:id',validate({params:applicationIdSchema}),deleteApplication)
